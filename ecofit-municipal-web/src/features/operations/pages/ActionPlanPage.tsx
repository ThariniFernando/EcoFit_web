...
function Spinner({ size = 16, color = "#555" }: { size?: number; color?: string }) {
  return (
    <span
      style={{
        ...
        borderRadius: "50%",
        animation: "actionPlanSpin 0.7s linear infinite",
...
export default function ActionPlanPage() {
  ...
  return (
    <div style={{ padding: 16 }}>
      ...
      <style>{`
        @keyframes actionPlanSpin {
          to { transform: rotate(360deg); }
        }
        @keyframes actionPlanPulse {
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap" }}>
          ...
          <button onClick={buildPlan} disabled={loading || !items.length || !tsPrediction}
            style={{
              padding: "8px 16px", borderRadius: 10, border: loading ? "1.5px solid rgb(45 106 79)" : "1px solid #ccc",
              background: loading ? "rgb(45 106 79)" : "white",
              color: loading ? "white" : "#333",
              cursor: loading ? "not-allowed" : "pointer", fontWeight: 700,
              display: "flex", alignItems: "center", gap: 8,
              transition: "all 0.3s ease",
              opacity: (!items.length || !tsPrediction) ? 0.5 : 1,
            }}>
      ...
      <div style={{ marginTop: 12, display: "grid", gridTemplateColumns: "1fr 520px", gap: 12, position: "relative" }}>
        ...
        {loading && (
          <div style={{
            ...
            <div style={{
              width: 56, height: 56,
              border: "4.5px solid #e0e0e0",
              borderTopColor: "rgb(45 106 79)",
              borderRadius: "50%",
              animation: "actionPlanSpin 0.8s linear infinite",
            }} />
            <div style={{
              fontWeight: 800, fontSize: 16, color: "rgb(45 106 79)",
              animation: "actionPlanPulse 1.8s ease-in-out infinite",
            }}>
              Generating Action Plan…
            </div>
            <div style={{ fontSize: 13, color: "#888" }}>
              Optimizing routes and allocating resources
            </div>
          </div>
        )}
