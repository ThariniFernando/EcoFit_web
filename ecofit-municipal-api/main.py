...
from routers.knowledgebase_router import english_router as kb_english_router
from routers.knowledgebase_router import sinhala_router as kb_sinhala_router
...
app.include_router(kb_english_router)
app.include_router(kb_sinhala_router)
